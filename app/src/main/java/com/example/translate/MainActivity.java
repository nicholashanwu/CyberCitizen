...
//                    handled = true;
    ...
    public static void insertContentData(DatabaseHelper myDb, Activity activity) {
        ...
        myDb.insertContentData("What is Cyber?", 3, "Data Breaches", "3.\tConsider freezing your account. Freezing your bank account makes it harder to access the credit and access reports. Contacting the financial institutions, notifying the team and requesting help and advice is the most suitable course of action.");
